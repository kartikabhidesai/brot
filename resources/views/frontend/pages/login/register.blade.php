                    ...
                    <div class="col-lg-6">
                        <div class="login-reg-form-wrap signup-form">
                            ...
                            <form method="post" id='registerform' action="{{ action('frontend\LoginController@register') }}" method="post">{{ csrf_field() }}
                                ...
                                <div class="single-input-item">
                                    <input type="text" class="form-control" placeholder="Enter Your 10 Digit Mobile Number" name='mobile' id='mobile'>
                                </div>
                                <div class="single-input-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="single-input-item">
                                            <input type="password" class="form-control" placeholder="Repeat your Password" name='confirmpassword' id='confirmpassword'>
                                        </div>
                                    </div>
                                </div>
                                <div class="single-input-item">
