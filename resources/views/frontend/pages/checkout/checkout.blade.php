                    ...
                    <div class="billing-form-wrap">
                        <form action="#">{{ csrf_field() }}
                            ...
                            <div class="single-input-item">
                                ...
                                <select name="country nice-select" id="country" class='country'>
                            ...
                            <div class="single-input-item">
                                ...
                                <select name="state nice-select" id="state" class='state'>
                    ...
                    <div class="order-summary-content">
                        ...
                        <div class="order-summary-table table-responsive text-center">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        <td><a href="product-details.html">Suscipit Vestibulum <strong> × 1</strong></a></td>
                                        <td>$165.00</td>
                                    </tr>
                                    <tr>
                                        <td><a href="product-details.html">Ami Vestibulum suscipit <strong> × 4</strong></a></td>
                                        <td>$165.00</td>
                                    </tr>
                                    <tr>
                                        <td><a href="product-details.html">Vestibulum suscipit <strong> × 2</strong></a></td>
                                        <td>$165.00</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                            ...
                            <div class="single-payment-method">
                                <div class="payment-method-name">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="paypalpayment">Paypal <img src="{{ url('frontend/assets/img/paypal-card.jpg') }}" class="img-fluid paypal-card" alt="Paypal" /></label>
                                    </div>
                                </div>
