            ...
            <div class="card-body ">
                <div class="row p-b-20">
                    <div class="col-md-6 col-sm-6 col-6">
                        <div class="btn-group">
                            <a href="{{ route('Product') }}" id="addRow" class="btn btn-info">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                <td class="user-circle-img">
                                    ...
                                    <img height="50px" width="50px" src="{{ url('/uploads/product/'.$value->holding_img) }}" alt="User's Profile Picture">
                                    @else
                                ...
                                <td class="center">
                                    <a href="{{ route('Update-Product',$value->id) }}" class="btn btn-tbl-edit btn-xs">
