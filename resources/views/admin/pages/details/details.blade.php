            ...
            <div class="card-body " id="bar-parent">
                <form method="post" id='details'>{{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="information" name="information" placeholder="Enter information">{{ isset($details[0]) ? $details[0]->info : ''}}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="simpleFormEmail">Address Line 1</label>
                        <input type="text" class="form-control" id="categoryname" value="{{ isset($details[0]) ? $details[0]->addressline1 : ''}}" name="addressline1" placeholder="Enter address line 1">
                    </div>

                    <div class="form-group">
                        <label for="simpleFormEmail">Address Line 2</label>
                        <input type="text" class="form-control" id="categoryname" value="{{ isset($details[0]) ? $details[0]->addressline2 : ''}}" name="addressline2" placeholder="Enter address line 2">
                    </div>
